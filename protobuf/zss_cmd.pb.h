...
class Robots_Command :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Robot_Command >*
      mutable_command();
  private:
  const ::Robot_Command& _internal_command(int index) const;
  ::Robot_Command* _internal_add_command();
  public:
...
inline const ::Robot_Command& Robots_Command::_internal_command(int index) const {
...
inline ::Robot_Command* Robots_Command::_internal_add_command() {
  return command_.Add();
}
